...
export default function ConsoleOutput({ lines, previousLineCount, isSimulationComplete = false }: ConsoleOutputProps) {
        ...
        <div ref={scrollRef} className="program-scroll flex-1 overflow-y-auto text-xs">
            <AnimatePresence mode="sync">
                {displayLines.map((line) => {
                    ...
                    const isCurrentLine = !line.isPlaceholder &&
                    ...
                    return (
                        <motion.div
                            ...
                            className={cn(
                                'py-0.5 rounded px-1 transition-all duration-300',
                                line.isPlaceholder
                                    ? 'text-slate-500 italic'
                                    : isCurrentLine
                                        ? 'text-accent-console bg-accent-console/15 font-medium'
