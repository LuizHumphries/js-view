...
type EventLoopSpinnerProps = {
    status: SimulationStatus
    hasBuilt: boolean
}

export default function EventLoopSpinner({ status, hasBuilt }: EventLoopSpinnerProps) {
    ...
    return (
        <div className="absolute top-1/2 left-1/2 z-20 -translate-x-1/2 -translate-y-1/2">
            ...
            {isAnimating && (
                <motion.div
                    className="absolute inset-0 rounded-full bg-accent-gold/5"
