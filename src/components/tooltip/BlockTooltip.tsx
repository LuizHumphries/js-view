...
export default function BlockTooltip({ text }: BlockTooltipProps) {
    return (
        <Tooltip.Provider>
            <div className="flex rounded-md p-0.5">
                <Tooltip.Root>
                    <Tooltip.Trigger className="flex size-4 items-center justify-center rounded-sm border-0 bg-transparent text-gray-900 select-none focus-visible:bg-none focus-visible:outline-2 focus-visible:-outline-offset-1 focus-visible:outline-blue-800 focus-visible:not-[&:hover]:bg-transparent">
                        <LucideInfo aria-label="Info" className="size-4" />
                    </Tooltip.Trigger>
                    <Tooltip.Portal>
